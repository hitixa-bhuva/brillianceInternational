<?php
   $Title = "Contact Brilliance International | Global Exporters from Morbi, India";
   $MetaDescription = "Get in touch with Brilliance International for premium agricultural and construction material exports. Reach us via phone, email, or visit our Morbi office.";
   $MetaKeywords = "Contact Brilliance International, exporters contact India, export inquiries, Morbi exporters contact, agricultural export contact";
?>
         ...
         <div class="page-content">
                           ...
                           <div class="pbmit-ihbox-headingicon">
                              <div class="pbmit-ihbox-wrap">
                                 <div class="pbmit-ihbox-contents">
                                    ...
                                    <div class="pbmit-heading-desc">
                                       <a href="mailto:thebrillianceinternational21@gmail.com" class="text-dark">thebrillianceinternational21@gmail.com</a>
                                    </div>
                                 </div>
                                    ...
                                    <div class="pbmit-ihbox-icon-wrapper pbmit-icon-type-icon">
                                       <svg height="512" viewbox="0 0 32 32" width="512" xmlns="http://www.w3.org/2000/svg">
                                          <g id="Layer_34" data-name="Layer 34">
                                             <path d="m30 9v14a3 3 0 0 1 -3 3h-22a3 3 0 0 1 -3-3v-14a2.87 2.87 0 0 1 .19-1l12.15 8.1a3 3 0 0 0 3.32 0l12.15-8.1a2.87 2.87 0 0 1 .19 1zm-13.45 5.43 12-8a3 3 0 0 0 -1.55-.43h-22a3 3 0 0 0 -1.54.44l12 8a1 1 0 0 0 1.09-.01z"></path>
                                          </g>
                                       </svg>
                                    </div>
                                 </div>
                              ...
                              <div class="pbmit-btn-wrap">
                                 <div class="pbmit-ihbox-btn">
                                    <a class="pbmit-button-inner" href="mailto:thebrillianceinternational21@gmail.com">
                           ...
                           <div class="pbmit-ihbox-headingicon">
                              <div class="pbmit-ihbox-wrap">
                                 <div class="pbmit-ihbox-contents">
                                    ...
                                    <div class="pbmit-heading-desc">Phone: +91 92745 57070
                                    </div>
                                 </div>
                                 <div class="pbmit-ihbox-icon">
                                    <div class="pbmit-ihbox-icon-wrapper pbmit-icon-type-icon">
                                       <svg id="glyph" height="512" viewbox="0 0 64 64" width="512" xmlns="http://www.w3.org/2000/svg">
                                          <path d="m59.96 49.01a4.62953 4.62953 0 0 0 -2.75-3.78c-2.31-1.03-6.61-2.91-9.39-3.95-4.45-1.66-6.29.68-6.38.8-.02.03-1.81 2.46-4.08 2.89-1.31.26-6.72-4-10.9-8.11-5.72-6.08-7.58-9.45-7.43-10.22.43-2.27 2.86-4.07 2.91-4.1.1-.07 2.44-1.92.78-6.37-1.03-2.77-2.92-7.07-3.95-9.38-1.5764-3.4361-5.5521-3.29475-8.68-1.73993-8.7274 6.65643-9.34882 21.56059 7.29029 39.04981 11.36282 11.06264 19.38064 15.59555 28.57961 15.88034 8.9001-.00022 12.9401-5.98022 12.9901-6.06022a9.325 9.325 0 0 0 1.01-4.91z"></path>
                                          <path d="m31.8667 23.2832a9.01535 9.01535 0 0 1 7.90864 7.9078.99981.99981 0 0 0 1.98636-.22667 11.02563 11.02563 0 0 0 -9.6685-9.66833 1.00005 1.00005 0 1 0 -.2265 1.98724z"></path>
                                          <path d="m32.41748 18.34473a14.00139 14.00139 0 0 1 12.29533 12.29548 1.00016 1.00016 0 0 0 1.98835-.215 16.0126 16.0126 0 0 0 -14.06892-14.06867 1.00007 1.00007 0 0 0 -.21476 1.98819z"></path>
                                          <path d="m32.96729 13.39648a19.0343 19.0343 0 0 1 16.69371 16.69346 1.00056 1.00056 0 0 0 1.98837-.22184 21.046 21.046 0 0 0 -18.46003-18.4588 1 1 0 0 0 -.22205 1.98718z"></path>
                                       </svg>
                                    </div>
                                 </div>
                              </div>
                              <div class="pbmit-btn-wrap">
                                 <div class="pbmit-ihbox-btn">
                                    <a class="pbmit-button-inner" href="tel:+919274557070">
                                    <span class="pbmit-button-icon"></span>
                                    </a>
                                 </div>
                              </div>
                     ...
                     <article class="pbmit-miconheading-style-5 col-md-6 col-lg-4 col-xl-3">
                        <div class="pbmit-ihbox-style-5">
                           <div class="pbmit-ihbox-headingicon">
                                 ...
                                 <div class="pbmit-ihbox-icon">
                                    <div class="pbmit-ihbox-icon-wrapper pbmit-icon-type-icon">
                                       <svg id="bold" enable-background="new 0 0 24 24" height="512" viewbox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg">
                                          <path d="m16.25 13h-1.25v-.75c0-.965-.785-1.75-1.75-1.75h-2.5c-.965 0-1.75.785-1.75 1.75v.75h-1.25c-.492 0-.935.205-1.253.533l5.503 2.871 5.503-2.871c-.318-.328-.761-.533-1.253-.533zm-5.75 0v-.75c0-.138.112-.25.25-.25h2.5c.138 0 .25.112.25.25v.75z"></path>
                                          <path d="m12.347 17.915c-.217.113-.477.113-.693 0l-5.654-2.95v4.285c0 .965.785 1.75 1.75 1.75h8.5c.965 0 1.75-.785 1.75-1.75v-4.285z"></path>
                                          <path d="m21 3h-1v-2c0-.552-.448-1-1-1h-1c-.552 0-1 .448-1 1v2h-10v-2c0-.552-.448-1-1-1h-1c-.552 0-1 .448-1 1v2h-1c-1.654 0-3 1.346-3 3v15c0 1.654 1.346 3 3 3h18c1.654 0 3-1.346 3-3v-15c0-1.654-1.346-3-3-3zm0 19h-18c-.552 0-1-.448-1-1v-11.96h20v11.96c0 .552-.448 1-1 1z"></path>
                                       </svg>
                                    </div>
                                 </div>
                              </div>
                              <div class="pbmit-btn-wrap">
                                 <div class="pbmit-ihbox-btn">
                                    <a class="pbmit-button-inner" href="about-us">
                                    <span class="pbmit-button-icon"></span>
                                    </a>
                                 </div>
                              </div>
                  ...
                  <div class="row g-0">
                     ...
                     <div class="col-md-12 col-xl-6">
                        <div class="contact-form-rightbox pbmit-bg-color-white">
                           ...
                           <form class=""  id="contact-Inquiry-form" novalidate>
                              <div class="row">
                                 <div class="col-md-6">
            ...
            <section class="contact-iframe-section">
               <div class="container-fluid p-0">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3677.6020950276725!2d70.8135472753077!3d22.817203379318283!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjLCsDQ5JzAxLjkiTiA3MMKwNDgnNTguMCJF!5e0!3m2!1sen!2sin!4v1748847407242!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>               </div>
            </section>
            <!-- Iframe End-->
         </div>
